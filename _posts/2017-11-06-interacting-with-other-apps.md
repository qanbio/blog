...
# Conclusion
Sur Android, les applications ne sont pas obligées d'implémenter toutes les fonctionnalités dont elles ont besoin pour offrir le service pour lequel elles sont conçues. La plateforme Android offre aux développeurs des mécanismes flexibles et efficaces pour permettre l'interopérabilité de leurs produits. Le concept d'Intent représente le coeur même du développement Android, parce qu'il offre la possibilité à une application, de solliciter les resources d'une autre application tierce, pour exécuter une tâche critique à son propre service.