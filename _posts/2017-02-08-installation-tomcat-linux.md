...
![page de téléchargement de tomcat](../../../assets/media/url_tomcat.png " page de téléchargement de tomcat")
...
![Téléchargement de tomccat](../../../../../assets/media/wget_tomcat.png "Téléchargement de tomcat")
...
![Vérifier si l'archive tomcat a été bien téléchargé](../../../../../../assets/media/ls-la_after_wget_tomcat.png " vérifier téléchargement de tomcat")
...
![extraction de l'archive](../../../../assets/media/extract_tomcat.png "extraction de l'archive")
...
![ vérifier extraction de l'archive](../../../../assets/media/ls-la_after_extract_tomcat.png " verifier extraction de l'archive")
...
![ démarrer tomcat](../../../../assets/media/start_tomcat.png "demarrer tomcat")
